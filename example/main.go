...
func get(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprint(w, `<!doctype html><meta charset=utf-8><html lang=ru><head></head><body><div>`, "<img src=\"data:image/png;base64,", pngbase64, "\">", txt, " your address:", r.RemoteAddr, "</div></body></html>")
}
